                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge variant="outline" className="text-orange-400 border-orange-400">
                        {(selectedScenario.probability * 100).toFixed(0)}% chance
                      </Badge>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-red-400 font-bold">{selectedScenario.impactAnalysis.portfolioLossPercent.toFixed(1)}%</span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-green-400 font-bold">{(selectedScenario.mitigation.riskReduction * 100).toFixed(0)}%</span>
                        </div>
                        <div className="flex justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-4 text-sm">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-orange-400">{(scenario.probability * 100).toFixed(0)}%</span>
                        </div>
                        <div className="flex items-center space-x-1">
                    ...
                    <div className="text-right space-y-2">
                      ...
                      <div className="text-sm text-slate-400">
                        {(scenario.impactAnalysis.portfolioLossPercent).toFixed(1)}% of portfolio
                      </div>
                      <Button 
                        size="sm" 
                        variant="outline"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {scenario.affectedPositions.map((position) => (
                        <Badge 
                          ...
                          className="text-xs"
                        >
                          {position.symbol} ({position.strategy}) -${(position.lossPercent * 100).toFixed(0)}%
                        </Badge>
                      ))}
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-900/30 p-4 rounded-lg border border-green-700">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-slate-400 text-sm">Risk Reduction</span>
                        <span className="text-green-400 font-medium">{(selectedScenario.mitigation.primary.riskReduction * 100).toFixed(0)}%</span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-green-400 text-sm">{(selectedScenario.mitigation.effectiveness * 100).toFixed(0)}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-900/30 p-4 rounded-lg border border-blue-700">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        <span className="text-slate-400 text-sm">Risk Reduction</span>
                        <span className="text-blue-400 font-medium">{(selectedScenario.mitigation.alternative.riskReduction * 100).toFixed(0)}%</span>
                      </div>
                      <div className="flex justify-between">
